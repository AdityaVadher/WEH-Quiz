...
export default function Home() {
  ...
  if (loading) return <main className="grid min-h-screen place-items-center bg-[#07111f] text-[#ffd34e]"><div className="brand-lockup"><Gamepad2 /> Loading Guess the Founder…</div></main>;
