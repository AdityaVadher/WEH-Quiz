        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              <Button variant="outline" onClick={() => void hostAction("next_clue")} disabled={busy || game.clueIndex === 4} className="border-white/15 bg-white/5 text-white hover:bg-white/10">Next clue <ChevronRight /></Button>
            </div>
          </div>
          <div>
